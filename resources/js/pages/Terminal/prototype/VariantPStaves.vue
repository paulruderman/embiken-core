    ...
    <div class="flex min-h-screen flex-col bg-rose-950 pb-24 text-rose-50">
        ...
        <aside v-if="focus" class="border-t border-rose-800 p-3">
            ...
            <div v-else class="grid grid-cols-4 gap-2">
                ...
                <button type="button" class="h-14 rounded-xl bg-orange-500 text-rose-950" @click="desk.markReturned(focus)">Return</button>
                ...
                <button type="button" class="h-14 rounded-xl bg-rose-800" @click="desk.acceptWaiver(focus)">Waiver</button>
