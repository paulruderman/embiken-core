        ...
        <aside v-if="focus" class="border-t border-zinc-700 p-3">
            ...
            <div v-else-if="pane === 'assign'" class="flex flex-wrap gap-2">
                <button
                    ...
                    :key="bike.id"
                    type="button"
                    class="h-14 w-14 rounded-xl bg-zinc-800 text-lg font-bold"
                    @click="pickBike(bike)"
                >
                    {{ bike.bid }}
                </button>
            ...
            <div v-else class="grid grid-cols-4 gap-2">
                ...
                <button type="button" class="h-14 rounded-xl bg-orange-500 text-zinc-950" @click="markReturned(shop, focus, 'back')">
                    Return
                </button>
