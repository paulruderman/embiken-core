...
class RecordOtherPaymentAction extends Action
{
    use AuthorizesStaff;

    public string $commandSignature = 'reservations:other {reservation?} {amount?} {--tenant=} {--note=}';
    ...
    {
        $router->post('/reservations/{reservation}/other', static::class)->name('reservations.other');
    }
    ...
    public function asCommand(Command $command): int
    {
        ...
        $command->info("Other {$transaction->id}");
