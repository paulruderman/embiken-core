...
Do not heal stale Out rows from an observer. Healing belongs in mutating App\Services\Availability (allocate, swapAsset) or the scheduled tick, not quoteOccupancy. Do not heal an Out line on a Cancelled reservation from allocate or the tick.
