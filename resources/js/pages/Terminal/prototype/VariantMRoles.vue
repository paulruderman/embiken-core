    ...
    <div class="flex min-h-screen flex-col bg-slate-950 pb-24 text-slate-50">
        ...
        <aside v-if="focus" class="border-t border-slate-800 p-3">
            ...
            <div v-else class="grid grid-cols-4 gap-2">
                ...
                <button type="button" class="h-14 rounded-xl bg-orange-500 text-slate-950" @click="desk.markReturned(focus)">Return</button>
                ...
                <button type="button" class="h-14 rounded-xl bg-slate-800" @click="desk.acceptWaiver(focus)">Waiver</button>
